...
<template>
  <Layout>
    ...
    <template #doc-after>
      <Comments class="my-2" />
      <div id="busuanzi_container_site_pv" class="flex-row-c-c text-center op-60 hover:op-100 transition-opacity" data-fade><i class="i-solar:eye-outline p-2 mr-2"/><span id="busuanzi_value_site_pv"></span></div>
    </template>
  </Layout>
</template>
