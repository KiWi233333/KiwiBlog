...
<template>
  <section class="grid cols-1">
    ...
    <div class="card-df rounded-10px pb-6 border-default">
      <div class="text-sm flex-row-bt-c p-4 mb-4 op-60 hover:op-100 transition-opacity">
        <span>友情链接</span>
        <a href="/apply"
      ...
      <!-- <InfiniteSwiper :data="friendDomList" :isHoverPaused="false" offsetX="-140px" /> -->
      <InfiniteSwiperV2>
        <div class="grid items-start cols-3 gap-4 mt-8 flex-shrink-0 flex-nowrap mr-4">
